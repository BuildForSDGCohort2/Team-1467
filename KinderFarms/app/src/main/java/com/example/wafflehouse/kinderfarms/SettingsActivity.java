...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        settingsDisplayProfileImage = (CircleImageView) findViewById(R.id.settings_profile_avatar);
        ...
        settingsChangeProfileImageButton = (Button) findViewById(R.id.settings_change_avatar);
        settingsChangeStatusButton = (Button) findViewById(R.id.settings_change_status);
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
             ...
             if (!image.equals("default_avatar"))
             {
                 Picasso.get().load(image).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.default_avatar)
                         .into(settingsDisplayProfileImage, new Callback() {
                             ...
                             {
                                 Picasso.get().load(image).placeholder(R.drawable.default_avatar).into(settingsDisplayProfileImage);
                             }
                         });
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task)
                    {
                      ...
                      {
                          Toast.makeText(SettingsActivity.this, "Saving changes", Toast.LENGTH_LONG).show();
                                              ...
                                              .addOnCompleteListener(new OnCompleteListener<Void>()
                                              {
                                                  ...
                                                  public void onComplete(@NonNull Task<Void> task)
                                                  {
                                                      Toast.makeText(SettingsActivity.this,
                                                              "Image successfully updated", Toast.LENGTH_SHORT).show();
                                                      loadingBar.dismiss();
                                                  }
                                              });
                                  }
